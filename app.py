...
def show_calm_space():
    ...
    specific_need = st.text_input("Do you have any specific anxiety or stress-related needs?")
    if specific_need:
        st.write(f"Custom Plan for {specific_need}:")
        st.write(f"- Practice deep breathing exercises for 10 minutes today.")
        st.write(f"- Go for a 15-minute mindful walk.")
        st.write(f"- Write down 3 things you're thankful for today.")
